    ...
    <>
      <div className="container mx-auto md:px-8 pt-12">
        <div className="p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto text-center mt-12 border border-green-700 text-white">
          ...
          <Link
            to={"/"}
            className="mt-10 inline-block px-10 py-4 bg-orange-600 text-white font-extrabold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 space-x-2 transform hover:ring-4 hover:ring-orange-600/50 uppercase tracking-wider"
          >
            Continue Shopping
          </Link>
        </div>
